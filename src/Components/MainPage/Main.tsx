    ...
    <div className="lg:grid grid-cols-6 grid-rows-2 gap-[24px] pl-10 pr-10 mb-14 max-[1024px]:px-6">
      <div 
        ...
        <div>
          ...
          <h3 
            className="text-white text-[16px] leading-[140%] font-normal">
              Знайдіть ідеальний подарунок для будь-якої нагоди! У нас широкий асортимент, що включає ексклюзивні, креативні та персоналізовані варіанти для всіх вікових категорій та інтересів.
          </h3>
        </div>
      ...
      <div 
        ...
        <div>
          ...
          <h3
            className="text-white text-[16px] leading-[140%] font-normal">
              Не знаєте, що подарувати? Наш інтуїтивний генератор подарунків підбере найкращі варіанти на основі ваших відповідей! Просто пройдіть коротке опитування – і ми знайдемо ідеальний сюрприз.
          </h3>
        </div>
        <div 
      ...
      <div
        ...
        <div>
          ...
          <h3 
            className="text-white text-[16px] leading-[140%] font-normal">
              Ми гарантуємо оперативну доставку,<br /> щоб ваш подарунок прибув вчасно! <br />Обирайте зручний спосіб отримання: кур&apos;єрська доставка, самовивіз або <br /> електронні сертифікати в лічені хвилини.
          </h3>
        </div>
        <div
